...
class FileManager {
	 ...
	 */
	public static function downloadFileAsync(url:String, savePath:String, ?headers:Map<String, String>, ?onProgress:(Int64, Int64)->Void, ?onDone:Void->Void, ?onError:String->Void, retries:Int = 3):Void {
		enqueueAsync(() -> {
			var lastErr:String = "";
